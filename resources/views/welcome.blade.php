...
<body>
  ...
  <div class="sticky">
    <!-- header -->
    <header class="py-4 shadow-sm bg-white z-10">
      <div class="container flex items-center justify-between">
        <a href="index.html" class="bg-red-700 m-3 rounded-[5px]">
          <img src="assets/images/proquip-logo-native.webp" alt="Logo" class="w-32">
        </a>
          ...
          <div
            ...
            <div class="relative group">
              ...
              <div
                ...
                <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                  <img src="assets/images/icons/small-icon.svg" alt="small icon" class="w-4 h-4 object-contain">
  ...
  <div class="relative w-full h-[600px]">
    <video autoplay loop muted class="object-cover w-full h-full">
      <source src="PROQUIP.mp4" type="video/mp4">
    </video>

    <!-- Teks di atas video -->
    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center text-center text-white z-10">
      <h1 class="text-4xl font-medium capitalize bg-red-700 p-8 rounded-md">
        PROFESSIONAL EQUIPMENT <br> AND MACHINERY
      </h1>
    </div>
  </div>
  ...
  <div class=" bg-gradient-to-b from-white to-transparent">
    <div class="bg-cover bg-no-repeat bg-center h-[100vh] bg-fixed"
      style="background-image: url('home-catalogue-1.webp');">
      <div class="container">
        <h1
          class="lg:text-6xl text-center pt-24 text-white outline-1 font-medium  capitalize bg-red-700 p-4 rounded-md">
          BEST SELLER
        </h1>
      ...
      <div class="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
          ...
          <div>
            ...
            <p class="text-gray-500 text-sm">Order over Rp200</p>
          </div>
        </div>
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
    ...
    <div class="w-full  bg-cover bg-no-repeat bg-center h-[100vh] bg-fixed"
      style="background-image: url('bg-proquip.webp');" id="new-arrival">
    ...
    <div id="menu-sticky"
      ...
      <a href="#shop-by-category"
        ...
        <img src="assets/images/icons/sofa.svg" alt="sofa" class="w-8 h-8 object-contain">
      </a>
      <a href="#new-arrival"
        class="flex items-center px-4 py-3 hover:bg-gray-100 transition duration-500 ease-in-out transform hover:opacity-80">
        <img src="assets/images/icons/terrace.svg" alt="terrace" class="w-8 h-8 object-contain">
      </a>a
      <a href="#" class="flex items-center px-4 py-3 hover:bg-gray-100 transition">
        <img src="assets/images/icons/bed.svg" alt="bed" class="w-8 h-8 object-contain">
      </a>
      <a href="#" class="flex items-center px-4 py-3 hover:bg-gray-100 transition">
        <img src="assets/images/icons/office.svg" alt="office" class="w-8 h-8 object-contain">
      </a>
      <a href="#" class="flex items-center px-4 py-3 hover:bg-gray-100 transition">
        <img src="assets/images/icons/outdoor-cafe.svg" alt="outdoor" class="w-8 h-8 object-contain">
      </a>
      <a href="#" class="flex items-center px-4 py-3 hover:bg-gray-100 transition">
        <img src="assets/images/icons/bed-2.svg" alt="Mattress" class="w-8 h-8 object-contain">
      </a>
    </div>
    ...
    <script>
      window.addEventListener('scroll', function() {
        ...
        // Cek apakah scroll sudah melewati 400px
        if (scrollPosition >= 400) {
          banner.classList.remove('relative', 'transition-all');
          banner.classList.add('absolute', 'top-0', 'transition-all', 'duration-500', 'ease-out');
        } else {
          // Kembali ke posisi semula saat scroll kurang dari 400px
          banner.classList.remove('absolute', 'top-0', 'transition-all', 'duration-500', 'ease-out');
          banner.classList.add('relative', 'transition-all', 'duration-500', 'ease-out');
        }
      });
    </script>
